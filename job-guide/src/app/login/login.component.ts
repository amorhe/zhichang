...
export class LoginComponent implements OnInit {
  ...
  public async login() {
    if (this.validateForm.valid) {
      let data = Object.assign(this.validateForm.value, {flag: this.flag});
      let res = await this.httpService.login(data);
      if (res.code === 200) {
